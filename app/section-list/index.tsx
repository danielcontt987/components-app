      ...
      <ThemeCard>
        <SectionList
          ...
          renderSectionHeader={({section}) => (
            <ThemeText type='h1' className='bg-light-backgorund dark:bg-dark-backgorund p-2 rounded'>{section.title}</ThemeText>
          )}
          stickySectionHeadersEnabled
          ListFooterComponent={() => (
            <ThemeText type='h1' className='font-bold mb-10 bg-light-backgorund dark:bg-dark-backgorund p-2 rounded'>
